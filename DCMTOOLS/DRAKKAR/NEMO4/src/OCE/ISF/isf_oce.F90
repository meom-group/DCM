MODULE isf_oce
   ...
   INTEGER    , PUBLIC                      :: nn_fwfisf_freq     !: number of fwf dataset
   TYPE(FLD_N), PUBLIC,       DIMENSION(5)  :: sn_isfpar_fwf2  !: information about the isf melting extra freq
   TYPE(FLD_N), PUBLIC, SAVE, DIMENSION(6)  :: slf_isfpar_fwf                 !:
#endif
   !
